...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		WARP_NODE(0x0B, LEVEL_BBH, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		MARIO_POS(0x01, -180, -1475, 80, 1897),
		OBJECT(MODEL_NONE, -1475, 80, 1897, 0, -180, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_BLACK_BOBOMB, 700, 0, 0, 0, 0, 0, 0x00000000, bhvBobombBuddy),
		OBJECT(MODEL_BLACK_BOBOMB, -700, 0, 0, 0, 0, 0, 0x00000000, bhvBobombBuddy),
		OBJECT(MODEL_BOWSER, 0, 0, 1056, 0, -180, 0, 0x00000000, bhvBowser),
		OBJECT(MODEL_NONE, -1463, 0, 1881, 0, 0, 0, (0x0B << 16), bhvWarp),
		TERRAIN(jrb_area_1_collision),
		MACRO_OBJECTS(jrb_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_UNDERGROUND),
		SHOW_DIALOG(0x00, DIALOG_009),
