...
const GeoLayout ccm_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, ccm_dl_1_geo),
			GEO_BRANCH(1, ccm_dl_2_geo),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout ccm_dl_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout ccm_dl_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -11996, 1325, 8680, ccm_dl_parkourcube_018_mesh_layer_1),
