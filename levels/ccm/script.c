...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_STAR, -47, -116, -4104, 0, 0, 0, (2 << 24), bhvStar),
		OBJECT_WITH_ACTS(MODEL_NONE, 0, 0, 0, 0, 0, 0, (100 << 24) | (0x0C << 16), bhvWarp, ACT_3),
		...
		OBJECT(MODEL_NONE, 2, -50, -4250, 0, 0, 0, (0x0D << 16), bhvWarp),
