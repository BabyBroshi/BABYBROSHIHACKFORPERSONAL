...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_BLUE_COIN_SWITCH, -3560, 13791, 2034, 0, 0, 0, 0x00000000, bhvBlueCoinSwitch),
		OBJECT(MODEL_BLUE_COIN, -4085, 13819, 1239, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4085, 13819, 1239, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4085, 13819, 1239, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4085, 13819, 1239, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4085, 13819, 1239, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		...
		OBJECT(MODEL_STAR, -34, 14863, 0, 0, 0, 0, (3 << 24), bhvStar),
		OBJECT(MODEL_STAR, -7775, 15111, 0, 0, 0, 0, (1 << 24), bhvStar),
		OBJECT(MODEL_STAR, -2404, 15125, -3241, 0, 0, 0, (2 << 24), bhvStar),
		OBJECT(MODEL_STAR, -6527, 10658, 1264, 0, 0, 0, (4 << 24), bhvStar),
		OBJECT(MODEL_STAR, 0, 13255, 15265, 0, 0, 0, (5 << 24), bhvStar),
