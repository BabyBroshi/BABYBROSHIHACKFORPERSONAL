...
const LevelScript level_bits_entry[] = {
	...
	LOAD_YAY0(0x5, _group7_yay0SegmentRomStart, _group7_yay0SegmentRomEnd), 
	...
	AREA(1, bits_area_1),
		...
		WARP_NODE(0x0B, LEVEL_BOWSER_3, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		MARIO_POS(0x01, 0, 7000, -12620, 0),
		OBJECT(MODEL_NONE, 7000, -12620, 0, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
