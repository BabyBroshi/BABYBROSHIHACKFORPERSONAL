...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_RED_COIN, 6237, -123, 0, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_TOAD, 12425, -183, 2096, 0, 0, 0, (47 << 24), bhvToadMessage),
		OBJECT(MODEL_NONE, 7340, 272, 0, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
