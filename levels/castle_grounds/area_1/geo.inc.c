...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 82, 11564, castle_grounds_dl_beythamodelmario_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -2024, 486, 0, 90, 0, -90, castle_grounds_dl_Image_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 0, 1303, -2024, 90, 0, 0, castle_grounds_dl_itch_iopage_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -400, 100, 2418, castle_grounds_dl_Stairs_mesh_layer_1),
