...
const GeoLayout wf_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -7832, 14412, 0, wf_dl_jaydensbus_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, wf_dl_jaydensbus_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -2381, 13787, -2598, 90, 0, -45, wf_dl_lad_larry_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 11, 14118, 0, 90, 0, -90, wf_dl_madmarcus_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -5097, 0, wf_dl_pipes_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -145, -500, 10, wf_dl_Water_Box_Mesh_mesh_layer_5),
