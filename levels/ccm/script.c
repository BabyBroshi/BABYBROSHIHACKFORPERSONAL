...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_BAGELER, -2513, 397, 0, 0, 0, 70, (0 << 24) | (1 << 16), bhvBageler, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_EVILSAULL, 0, 85, -292, 0, 90, 0, (0 << 24) | (1 << 16), bhvEvilsaull, ACT_1),
		OBJECT_WITH_ACTS(MODEL_EVILSAULL, 0, 143, -292, 0, 0, 0, (10 << 16), bhvExclamationBox, ACT_2),
