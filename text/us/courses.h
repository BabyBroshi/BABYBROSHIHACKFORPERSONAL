COURSE_ACTS(COURSE_BOB, _(" 1 THE SHIPS"),
       _("THE 8 RED COINS")     , _("TOP OF THE TOWER") , _("LOST IN THE CAVE"),
       _("UP TOP THE MOUNTAIN")          , _("SECRET OF THE BOB OMBS")        , _("THE INVISIBILITY CAP"))

COURSE_ACTS(COURSE_WF, _(" 2 MARCUS ADVENTURES"),
       _("GO IN THE TOILET TO FIX SOME STUFF")        , _("JAYDENS BUS IS HERE")    , _("CLIMB ON LAD LARRY"),
       _("TOILET"), _("FALL")    , _("GO SEARCH"))
...
COURSE_ACTS(COURSE_CCM, _(" 1 TWIST-UP TURN-TABLE"),
       _("THROW BAGELER")             , _("PUNCH SAUL")             , _("THE PARKOUR"),
       _("GO OUTSIDE")  , _("GET PAST THE GILBERTS UPSTAIRS")       , _("FIND THE RED COINS"))
...
COURSE_ACTS(COURSE_DDD, _(" 9 HAVE YOU EVER WANTED MOVIES FREE"),
       _("FNAF MOVIE")            , _("NONE")         , _("POLE-JUMPING FOR RED COINS"),
